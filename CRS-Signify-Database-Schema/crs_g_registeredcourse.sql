...
CREATE TABLE `registeredcourse` (
  ...
  CONSTRAINT `coursecode` FOREIGN KEY (`coursecode`) REFERENCES `catalog` (`coursecode`) ON DELETE RESTRICT,
  CONSTRAINT `studentid` FOREIGN KEY (`studentid`) REFERENCES `student` (`studentid`) ON DELETE RESTRICT
