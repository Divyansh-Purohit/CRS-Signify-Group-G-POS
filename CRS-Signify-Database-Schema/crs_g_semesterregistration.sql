...
CREATE TABLE `semesterregistration` (
  ...
  `mancourse1` varchar(45) DEFAULT NULL,
  `mancourse2` varchar(45) DEFAULT NULL,
  `mancourse3` varchar(45) DEFAULT NULL,
  `mancourse4` varchar(45) DEFAULT NULL,
  `altcourse1` varchar(45) DEFAULT NULL,
  `altcourse2` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`studentid`),
  UNIQUE KEY `studentid_UNIQUE` (`studentid`),
  CONSTRAINT `studentid_sem` FOREIGN KEY (`studentid`) REFERENCES `student` (`studentid`) ON DELETE CASCADE
