...
CREATE TABLE `professor` (
  ...
  CONSTRAINT `coursefk` FOREIGN KEY (`course`) REFERENCES `catalog` (`coursecode`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `professorid` FOREIGN KEY (`professorid`) REFERENCES `user` (`userid`) ON DELETE CASCADE
